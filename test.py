...
def checkOne(text):
    ...
    ham_score, spam_score, predicted_label = mail1.random_classifier(all_uniqueWords, spam_prob, ham_prob, spam_condProb, ham_condProb, delta=0.5)
