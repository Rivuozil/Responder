...
class RandomMail:
    ...
    def random_classifier(self, all_uniqueWords, spam_prob, ham_prob, spam_condProb, ham_condProb, delta=0.5):
        actual_label = ""
        predicted_label = ""
        #decision_label = ""
        ...
        email_words = text_parser(self.text_content)
        sigma_spamScore = 0
        sigma_hamScore = 0
        ...
        return ham_score, spam_score, predicted_label
